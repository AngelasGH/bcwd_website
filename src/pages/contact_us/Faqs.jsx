  ...
  return (
    <>
      ...
      <Container className='pb-5 mb-5'>
        ...
        <div className="col-10 col-md-10 col-lg-11 col-xl-12" style={{ margin: '20px auto', maxWidth: '1200px' }}>
          {questions.map((question, index) => (
            ...
            >
              ...
              >
                <div className='mx-3 px-2 mt-2'>
                  <p className="mydropdown" style={{ fontSize: "15px", fontFamily: "Roboto Regular" }}>{question}</p>
              ...
              {selected === index && (
                <div className='mx-3 px-2'>
                  <p style={{ fontSize: "13px", fontFamily: "Roboto Light", letterSpacing: "0.5px", textAlign: "justify" }}> {answers[index]}</p>
                </div>
              )}
            </div>
          ))}
